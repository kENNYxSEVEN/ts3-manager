...
export function ServerGroupPermissions() {
  ...
  const savePermission = async (
    ...
    try {
      ...
      await TeamSpeak.execute("servergroupaddperm", {
        ...
        permnegated: values.permnegated ? 1 : 0,
        permskip: values.permskip ? 1 : 0,
  ...
  const groupOptions = [
    ...(sgid && !groups.some((group) => String(group.sgid) === String(sgid))
  ...
  return (
    <>
      ...
      <PermissionPageFlow
        ...
        editableFields={["permvalue", "permskip", "permnegated"]}
